#ifndef TEN_KERNELS_TRIGONOMETRICS_HXX
#define TEN_KERNELS_TRIGONOMETRICS_HXX
...
static void trig_ops(const A &a, C &c) {
  size_t n = a.size();
...
static void trig_ops(const A &a, C &c) {
  ...
  using ::ten::binary_operation;
  using T = typename A::value_type;
  using vector_type = std::experimental::fixed_size_simd<double, vlen>;
  using alignment = std::experimental::element_aligned_tag;
