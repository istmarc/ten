...
// Inverse of a matrix
template <typename T>
static void inv(storage_order layout, size_t n, T *a, size_t lda,
                int32_t *ipiv);

template <>
static void inv(storage_order layout, size_t n, float *a, size_t lda,
                int32_t *ipiv) {
...
template <>
static void inv(storage_order layout, size_t n, double *a, size_t lda,
                int32_t *ipiv) {
